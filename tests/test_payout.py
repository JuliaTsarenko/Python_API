...
class TestWrongPayout:
    ...
    #     assert user1.merchant1.resp_payout_create['error']['data']['reason'] == 'Out pay is blocked for system'
    #
    ...
    #     assert user1.resp_delegate['data']['reason'] == 'Out pay is blocked for merchant {}'.format(user1.merchant1.lid)
    #     admin.set_pwcurrency_min_max(payway=admin.payway['visamc']['id'], is_out=True, currency='UAH',
    #                                  is_active=True, tech_min=bl(1), tech_max=bl(98))
    #
    ...
    #     assert user1.resp_delegate['data']['reason'] == 'Amount 20000000 less then balance 10000000'
    #     admin.set_pwcurrency_min_max(payway=admin.payway['visamc']['id'], is_out=True, currency='UAH',
    #                                  is_active=True, tech_min=bl(1), tech_max=bl(98))
    #
    ...
    #     assert user1.merchant1.resp_payout_create['error']['data']['reason'] == \
    #            'Amount 3020000000 less then balance 1020000000'
    #
    ...
    #            f'Active merchant with lid 1234567890 was not found for user with id {user1.id}'
    #     assert user1.resp_delegate['data']['reason'] == \
    #            'Active merchant with lid 1234567890 was not found for user with id {}'.format(user1.id)
    #     admin.set_pwcurrency_min_max(payway=admin.payway['visamc']['id'], is_out=True, currency='UAH',
    #                                  is_active=True, tech_min=bl(1), tech_max=bl(98))
    #
    ...
    #     assert user1.resp_delegate['message'] == 'NotFound'
    #     assert user1.resp_delegate['data']['reason'] == \
    #            f'Active merchant with lid {user1.merchant1.lid} was not found for user with id {user1.id}'
    #     assert user1.resp_delegate['data']['reason'] == \
    #            'Active merchant with lid {} was not found for user with id {}'.format(user1.merchant1.lid, user1.id)
    #     admin.set_pwcurrency_min_max(payway=admin.payway['visamc']['id'], is_out=True, currency='UAH',
    #                                  is_active=True, tech_min=bl(1), tech_max=bl(98))
    #
    ...
    #     assert user1.merchant1.resp_payout_create['error']['data']['reason'] == 'Invalid amount None for currency RUB'
    #
    ...
    #     assert loads(r.text)['error'] == {'code': -32602,
    #                                       'data': {'reason': "method 'payout.create' missing 1 argument: 'amount'"},
    ...
    #     # pprint.pprint(user1.merchant1.resp_payout_create)
    #     assert user1.merchant1.resp_payout_create['error']['message'] == 'InvalidAmountFormat'
    #     assert user1.merchant1.resp_payout_create['error']['data']['reason'] == 'Invalid format Test for RUB'
    #
    ...
    #     # pprint.pprint(user1.merchant1.resp_payout_create)
    #     assert user1.merchant1.resp_payout_create['error']['message'] == 'InvalidAmountFormat'
    #     assert user1.merchant1.resp_payout_create['error']['data']['reason'] == 'Invalid format 0.111 for RUB'
    #
    ...
    #     assert user1.merchant1.resp_payout_create['error']['data']['reason'] == 'TST'
    #
    ...
    #     assert user1.merchant1.resp_payout_create['error']['data']['reason'] == 'RUB'
    #
    ...
    #     # print(user1.merchant1.resp_payout_create)
    #     assert user1.merchant1.resp_payout_create['error']['message'] == 'InactiveCurrency'
    #     assert user1.merchant1.resp_payout_create['error']['data']['reason'] == 'UAH'
    #     admin.set_fee(mult=0, add=0, _min=0, _max=0, around='ceil', tp=10, currency_id=admin.currency['USD'],
    #                   payway_id=admin.payway['exmo']['id'], is_active=False)
    #
    ...
    #     assert user1.merchant1.resp_payout_create['error']['data']['reason'] == '1.02'
    #     admin.set_pwcurrency_min_max(payway=admin.payway['payeer']['id'], is_out=True, currency='RUB',
    #                                  is_active=True, tech_min=bl(1), tech_max=bl(3.36))
    #
    ...
    #     assert user1.merchant1.resp_payout_create['error']['data']['reason'] == '0.99999'
    #
    ...
    #     # print(user1.merchant1.resp_payout_create)
    #     assert user1.merchant1.resp_payout_create['error']['message'] == 'AmountTooSmall'
    #     assert user1.merchant1.resp_payout_create['error']['data']['reason'] == '238.55'
    #     admin.set_rate_exchange(rate=28199900000, fee=30000000, in_currency='UAH', out_currency='USD',
    #                             tech_min=bl(0.1), tech_max=bl(10000))
    #     admin.set_pwcurrency_min_max(payway=admin.payway['webmoney']['id'], is_out=True, currency='USD',
    #                                  is_active=False, tech_min=bl(1), tech_max=bl(0.97))
    ...
    #     # pprint.pprint(user1.merchant1.resp_payout_create)
    #     assert user1.merchant1.resp_payout_create['error']['message'] == 'InvalidAmountFormat'
    #     assert user1.merchant1.resp_payout_create['error']['data']['reason'] == 'Invalid format 0.009 for RUB'
    #
    ...
    #                                  is_active=True, tech_min=bl(0.01), tech_max=bl(98))
    #     user1.delegate(params={'merch_model': 'payout', 'merch_method': 'create', 'externalid': user1.ex_id(),
    #                            'payway': 'visamc', 'amount': '0.01', 'm_lid': user1.merchant1.lid,
    ...
    #     assert user1.resp_delegate['data']['reason'] == 'Unavailable excange for UAH to RUB'
    #     admin.set_pwcurrency_min_max(payway=admin.payway['paymer']['id'], is_out=True, currency='RUB',
    #                                  is_active=True, tech_min=bl(0.01), tech_max=bl(39.99))
    #
    ...
    #     # pprint.pprint(user1.resp_delegate)
    #     assert user1.resp_delegate['message'] == 'UnavailExchange'
    #     assert user1.resp_delegate['data']['reason'] == 'Unavailable excange for USD to RUB'
    #     admin.set_pwcurrency_min_max(payway=admin.payway['paymer']['id'], is_out=True, currency='RUB',
    #                                  is_active=True, tech_min=bl(0.01), tech_max=bl(39.99))
    #
    ...
    #     assert user1.merchant1.resp_payout_create['error']['data']['reason'] == 'Unavailable excange for UAH to USD'
    #     admin.set_pwcurrency_min_max(payway=admin.payway['webmoney']['id'], is_out=True, currency='USD',
    #                                  is_active=False, tech_min=bl(1), tech_max=bl(0.97))
    #     admin.set_fee(mult=0, add=0, _min=0, _max=0, around='ceil', tp=10, currency_id=admin.currency['USD'],
    #                   payway_id=admin.payway['webmoney']['id'], is_active=False)
    ...
    #     assert user1.merchant1.resp_payout_create['error']['message'] == 'UnavailExchange'
    #     assert user1.merchant1.resp_payout_create['error']['data']['reason'] == \
    #            'Unavailable excange for BCHABC to USD'
    #     admin.set_pwcurrency_min_max(payway=admin.payway['webmoney']['id'], is_out=True, currency='USD',
    #                                  is_active=False, tech_min=bl(1), tech_max=bl(0.97))
    #     admin.set_fee(mult=0, add=0, _min=0, _max=0, around='ceil', tp=10, currency_id=admin.currency['USD'],
    #                   payway_id=admin.payway['webmoney']['id'], is_active=False)
    ...
    def test_wrong_payout_61(self): # указана неверная платежная система
        ...
        assert user1.resp_delegate['data']['reason'] == 'test'
        admin.set_pwcurrency_min_max(payway=admin.payway['kuna']['id'], is_out=True, currency='UAH',
                                     is_active=True, tech_min=bl(1), tech_max=bl(98))
    ...
    def test_wrong_payout_62(self): # указана неверная платежная система
        ...
        assert user1.merchant1.resp_payout_create['error']['data']['reason'] == 'test'
...
class TestParams:
    ...
    #                            'in_curr': 'UAH', 'm_lid': user1.merchant1.lid})
    #     # pprint.pprint(user1.resp_delegate)
    ...
    #                                  is_active=True, tech_min=bl(0.01), tech_max=bl(50))
    #     user1.delegate(params={'merch_model': 'payout', 'merch_method': 'params', 'payway': 'paymer', 'out_curr': 'RUB',
    #                            'in_curr': 'TST', 'm_lid': user1.merchant1.lid})
    #     # pprint.pprint(user1.resp_delegate)
    #     assert user1.resp_delegate['message'] == 'InvalidCurrency'
    #     assert user1.resp_delegate['data']['reason'] == 'TST'
    #     admin.set_pwcurrency_min_max(payway=admin.payway['paymer']['id'], is_out=True, currency='RUB',
...
class TestGetCheque:
    ...
    #     user1.delegate(params={'merch_model': 'payout', 'merch_method': 'create', 'externalid': user1.ex_id(),
    #                            'payway': 'kuna', 'amount': '100', 'out_curr': 'UAH', 'm_lid': user1.merchant1.lid})
    #     # print('lid', user1.merchant1.lid)
    ...
    #     assert user1.merchant1.resp_payout_in_curr_list['cheque']['amount']== '100'
    #     assert user1.merchant1.resp_payout_in_curr_list['cheque']['currency']== 'UAH'
    #     assert user1.merchant1.resp_payout_in_curr_list['in_amount']== '100'
    #     assert user1.merchant1.resp_payout_in_curr_list['in_curr']== 'UAH'
    #     assert user1.merchant1.resp_payout_in_curr_list['in_fee_amount']== '0'
    #     assert user1.merchant1.resp_payout_in_curr_list['orig_amount']== '100'
    #     assert user1.merchant1.resp_payout_in_curr_list['out_amount']== '100'
    #     assert user1.merchant1.resp_payout_in_curr_list['out_curr']== 'UAH'
    #     assert user1.merchant1.resp_payout_in_curr_list['out_fee_amount']== '0'
    #     assert user1.merchant1.resp_payout_in_curr_list['payway_name']== 'kuna'
    #     assert user1.merchant1.resp_payout_in_curr_list['rate']== None
    #     assert user1.merchant1.resp_payout_in_curr_list['reqdata']['amount']== '100'
    #     assert user1.merchant1.resp_payout_in_curr_list['reqdata']['in_curr']== None
    #     assert user1.merchant1.resp_payout_in_curr_list['reqdata']['out_curr']== 'UAH'
    #     assert user1.merchant1.resp_payout_in_curr_list['reqdata']['payway']== 'kuna'
    #     assert user1.merchant1.resp_payout_in_curr_list['reqdata']['userdata']== {}
    #     assert user1.merchant1.resp_payout_in_curr_list['status']== 'done'
    #     assert user1.merchant1.resp_payout_in_curr_list['tp']== 'payout'
    #     assert user1.merchant1.resp_payout_in_curr_list['userdata']==  {'payee': ''}
    ...
    #     assert user1.merchant1.resp_payout_in_curr_list['message']== 'NotFound'
    #
    ...
    def test_GetCheque_5(self):
        ...
        # user1.merchant1.payout_in_curr_list(payway='payeer', out_curr='RUB')
        user1.merchant1.payout_get_cheque(lid=19337)#user1.resp_delegate['lid'])
        assert user1.merchant1.resp_payout_in_curr_list['data']['reason']== 'Missing report from core'
        assert user1.merchant1.resp_payout_in_curr_list['message']== 'ApiError'
