...
class TestSciRefundCalc:
    ...
    def test_wrong_sci_refund_calc_1(self):
        """ Payin with amount less than tech_min in pw_carrency table. """
        admin.set_pwc(pw_id=admin.payway_id['visamc'], currency='UAH', is_out=False, is_active=True,
                      tech_min=bl(0.01), tech_max=bl(150))
        user1.merchant1.sci_pay(method='create',
    ...
    def test_wrong_sci_refund_calc_2(self):
        """ Payin with amount more than tech_max in pw_carrency table. """
        admin.set_pwc(pw_id=admin.payway_id['privat24'], currency='UAH', is_out=False, is_active=True,
                      tech_min=bl(1), tech_max=bl(100))
        user1.merchant1.sci_pay(method='create',
    ...
    def test_wrong_sci_refund_calc_3(self):
        """ Payin with exchange: in_curr less than tech_min by exchange table
            Payin with exchange: in_curr more than tech_max by exchange table. """
        admin.set_pwc(pw_id=admin.payway_id['visamc'], currency='UAH', is_out=False, is_active=True,
                      tech_min=bl(4), tech_max=bl(105))
    ...
    def test_wrong_sci_refund_calc_4(self, _activate_pwcurrency):
        """ Refund for sci_pay from VISAMC 0.5 of 1 UAH by MERCHANT. """
        admin.set_fee(currency_id=admin.currency['UAH'], payway_id=admin.payway_id['visamc'], tp=40, is_active=True)
        admin.set_pwc(pw_id=admin.payway_id['visamc'], currency='UAH', is_out=False, is_active=True, tech_min=bl(0.01),
                      tech_max=bl(100))
    ...
    def test_wrong_sci_refund_calc_5(self):
        """ Payin with wrong merchant. """
        admin.set_fee(currency_id=admin.currency['UAH'], payway_id=admin.payway_id['visamc'], tp=40, is_active=True)
        admin.set_pwc(pw_id=admin.payway_id['visamc'], currency='UAH', is_out=False, is_active=True, tech_min=bl(0.01),
                      tech_max=bl(100))
    ...
    def test_wrong_sci_refund_calc_6(self):
        """ Payin without merchant. """
        admin.set_fee(currency_id=admin.currency['UAH'], payway_id=admin.payway_id['visamc'], tp=40, is_active=True)
        admin.set_pwc(pw_id=admin.payway_id['visamc'], currency='UAH', is_out=False, is_active=True, tech_min=bl(0.01),
                      tech_max=bl(100))
        ...
        # pprint.pprint(user1.merchant1.resp_sci_pay)
        # print('\n', 'sci_pay status', user1.merchant1.resp_sci_pay['status'])
        data = {'method': 'sci_refund.calc', 'params': {'sci_pay_token': user1.merchant1.sci_pay_token},
                'jsonrpc': 2.0, 'id': user1.merchant1._id()}
        time_sent = user1.merchant1.time_sent()
        r = requests.post(url=user1.merchant1.japi_url, json=data,
                          headers={'x-merchant': None,
    ...
    def test_wrong_sci_refund_calc_7(self):
        """ Payin with wrong sign. """
        admin.set_fee(currency_id=admin.currency['UAH'], payway_id=admin.payway_id['visamc'], tp=40, is_active=True)
        admin.set_pwc(pw_id=admin.payway_id['visamc'], currency='UAH', is_out=False, is_active=True, tech_min=bl(0.01),
                      tech_max=bl(100))
    ...
    def test_wrong_sci_refund_calc_8(self):
        """ Payin without sign. """
        admin.set_fee(currency_id=admin.currency['UAH'], payway_id=admin.payway_id['visamc'], tp=40, is_active=True)
        admin.set_pwc(pw_id=admin.payway_id['visamc'], currency='UAH', is_out=False, is_active=True, tech_min=bl(0.01),
                      tech_max=bl(100))
    ...
    def test_wrong_sci_refund_calc_9(self):
        """ Payin without utc_time. """
        admin.set_fee(currency_id=admin.currency['UAH'], payway_id=admin.payway_id['visamc'], tp=40, is_active=True)
        admin.set_pwc(pw_id=admin.payway_id['visamc'], currency='UAH', is_out=False, is_active=True, tech_min=bl(0.01),
                      tech_max=bl(100))
...
class TestSciRefundGet:
    ...
    def test_wrong_sci_refund_get_1(self):
        """ Refund for sci_pay from VISAMC 0.5 of 1 UAH by MERCHANT. """
        admin.set_fee(currency_id=admin.currency['UAH'], payway_id=admin.payway_id['visamc'], tp=40, is_active=True)
        admin.set_pwc(pw_id=admin.payway_id['visamc'], currency='UAH', is_out=False, is_active=True, tech_min=bl(0.01),
                      tech_max=bl(100))
        ...
        user1.merchant1.sci_refund(method='create', params={'sci_pay_token': user1.merchant1.sci_pay_token})
        # pprint.pprint(user1.merchant1.resp_sci_refund)
        user1.merchant1.sci_refund(method='get', params={})
        # pprint.pprint(user1.merchant1.resp_sci_refund)
        assert user1.merchant1.resp_sci_refund['code'] == -32002
        assert user1.merchant1.resp_sci_refund['data']['reason'] == \
               'Unable to complete: onl`y sci_pay_token or refund_token'
        assert user1.merchant1.resp_sci_refund['data']['value'] == None
        assert user1.merchant1.resp_sci_refund['message'] == 'EParamInvalid'

    def test_wrong_sci_refund_get_2(self):
        """ Refund for sci_pay from VISAMC 0.5 of 1 UAH by MERCHANT. """
        admin.set_fee(currency_id=admin.currency['UAH'], payway_id=admin.payway_id['visamc'], tp=40, is_active=True)
        admin.set_pwc(pw_id=admin.payway_id['visamc'], currency='UAH', is_out=False, is_active=True, tech_min=bl(0.01),
                      tech_max=bl(100))
        ...
        # pprint.pprint(user1.merchant1.resp_sci_refund)
        user1.merchant1.sci_refund(method='get', params={'sci_pay_token': user1.merchant1.sci_pay_token,
                                                         'refund_token': user1.merchant1.resp_sci_refund['token']})
        # pprint.pprint(user1.merchant1.resp_sci_refund)
        assert user1.merchant1.resp_sci_refund['code'] == -32002
        assert user1.merchant1.resp_sci_refund['data']['reason'] == \
               'Unable to complete: onl`y sci_pay_token or refund_token'
    ...
    def test_wrong_sci_refund_get_3(self):
        """ Refund for sci_pay from VISAMC 0.5 of 1 UAH by MERCHANT. """
        admin.set_fee(currency_id=admin.currency['UAH'], payway_id=admin.payway_id['visamc'], tp=40, is_active=True)
        admin.set_pwc(pw_id=admin.payway_id['visamc'], currency='UAH', is_out=False, is_active=True, tech_min=bl(0.01),
                      tech_max=bl(100))
        ...
        user1.merchant1.sci_refund(method='create', params={'sci_pay_token': user1.merchant1.sci_pay_token})
        # pprint.pprint(user1.merchant1.resp_sci_refund)
        user1.merchant1.sci_refund(method='get',
                                   params={'sci_pay_token':
                                               '0K3PaUSGxL_cvJxjtpPCMvRwQU4CzpV_t8MKpje7sszEHJJQXbsRWWOkx4arn0pOQ3TX'})
        # pprint.pprint(user1.merchant1.resp_sci_refund)
        ...
        assert user1.merchant1.resp_sci_refund['message'] == 'EParamNotFound'

    def test_wrong_sci_refund_get_4(self):
        """ Refund for sci_pay from VISAMC 0.5 of 1 UAH by MERCHANT. """
        admin.set_fee(currency_id=admin.currency['UAH'], payway_id=admin.payway_id['visamc'], tp=40, is_active=True)
        admin.set_pwc(pw_id=admin.payway_id['visamc'], currency='UAH', is_out=False, is_active=True, tech_min=bl(0.01),
                      tech_max=bl(100))
    ...
    def test_wrong_sci_refund_get_33(self):
        """ Refund for sci_pay from VISAMC 0.5 of 1 UAH by MERCHANT. """
        admin.set_fee(currency_id=admin.currency['UAH'], payway_id=admin.payway_id['visamc'], tp=40, is_active=True)
        admin.set_pwc(pw_id=admin.payway_id['visamc'], currency='UAH', is_out=False, is_active=True, tech_min=bl(0.01),
                      tech_max=bl(100))
        ...
        # pprint.pprint(user1.merchant1.resp_sci_refund)
        assert user1.merchant1.resp_sci_refund['code'] == -32090
        assert user1.merchant1.resp_sci_refund['data']['field'] == 'refund_token'
        assert user1.merchant1.resp_sci_refund['data']['reason'] == 'Not found'
        assert user1.merchant1.resp_sci_refund['message'] == 'EParamNotFound'
...
class TestSciRefundParams:
    ...
    def test_sci_refund_params_1(self):
        ...
        # pprint.pprint(user1.merchant1.resp_sci_refund)
        assert user1.merchant1.resp_sci_refund['in_curr'] == 'UAH'
        assert user1.merchant1.resp_sci_refund['is_convert'] == False
        assert user1.merchant1.resp_sci_refund['max'] == '3000'
        assert user1.merchant1.resp_sci_refund['min'] == '0.01'
        assert user1.merchant1.resp_sci_refund['out_curr'] == 'UAH'
        assert user1.merchant1.resp_sci_refund['out_fee'] == {'add': 0, 'm': 'ceil', 'max': 0, 'min': 0, 'mult': 0}
        assert user1.merchant1.resp_sci_refund['payway'] == 'anycash'
        assert user1.merchant1.resp_sci_refund['pwtp'] == 'cheque'
        assert user1.merchant1.resp_sci_refund['rate'] == ['1', '1']
        assert user1.merchant1.resp_sci_refund['uaccount'] == None

    def test_sci_refund_params_2(self):
        """ Calc for sci_pay from PAYEER 1.02 USD by OWNER. """
        admin.set_fee(currency_id=admin.currency['USD'], payway_id=admin.payway_id['payeer'], tp=40, is_active=True)
        admin.set_fee(currency_id=admin.currency['USD'], payway_id=admin.payway_id['payeer'], tp=45, is_active=True)
        admin.set_fee(currency_id=admin.currency['USD'], payway_id=admin.payway_id['payeer'], tp=46, is_active=True)
        admin.set_pwc(pw_id=admin.payway_id['payeer'], currency='USD', is_out=False, is_active=True,
                      tech_min=bl(0.5), tech_max=bl(100))
        user1.delegate(params={'externalid': user1.ex_id(), 'expiry': '7d', 'm_lid': user1.merchant1.lid,
                               'merch_model': 'sci_pay', 'merch_method': 'create',
        ...
        admin.set_order_status(lid=user1.resp_delegate['lid'], status=100)
        admin.set_order_status(lid=sci_pay_lid, status=0, amount_paid=bl(0.52))
        user1.delegate(params={'m_lid': user1.merchant1.lid,  'merch_model': 'sci_refund', 'merch_method': 'params',
                               'curr': 'USD'})
        # pprint.pprint(user1.resp_delegate)
        assert user1.resp_delegate['in_curr'] == 'USD'
    ...
    def test_sci_refund_params_4(self):
        """ SCI payin from QIWI 10 RUB by OWNER with common absolute fee 1 RUB and common percent fee 5.5% . """
        admin.set_wallet_amount(balance=0, currency='RUB', merch_lid=user1.merchant1.lid)
        admin.set_fee(currency_id=admin.currency['RUB'], payway_id=admin.payway_id['qiwi'], tp=40, is_active=True,
                      mult=pers(5.5), add=bl(1))
        admin.set_fee(currency_id=admin.currency['RUB'], tp=46, is_active=True, payway_id=admin.payway_id['anycash'],
                      mult=pers(5.5), add=bl(1))
        admin.set_pwc(pw_id=admin.payway_id['qiwi'], currency='RUB', is_out=False, is_active=True,
                      tech_min=bl(0.05), tech_max=bl(1000))
        user1.delegate(params={'m_lid': user1.merchant1.lid, 'merch_model': 'sci_pay', 'merch_method': 'create',
                               'out_curr': None, 'payway': 'qiwi', 'externalid': user1.ex_id(), 'amount': '10',
                               'in_curr': 'RUB', 'expiry': '7d'})
        # pprint.pprint(user1.resp_delegate)
        sci_pay_lid = user1.resp_delegate['lid']
        sci_pay_token = user1.resp_delegate['token']
        user1.delegate(params={'sci_pay_token': sci_pay_token, 'externalid': user1.ex_id(), 'm_lid': user1.merchant1.lid,
                               'merch_model': 'sci_subpay', 'merch_method': 'create',
                               'payway': 'qiwi', 'amount': '4', 'in_curr': 'RUB', 'contact': '+123@gmail.com',
                               'payer': '+380663319145'})
        # pprint.pprint(user1.resp_delegate)
        admin.set_order_status(lid=user1.resp_delegate['lid'], status=100)
        admin.set_order_status(lid=sci_pay_lid, status=0, amount_paid=bl(4))
    ...
    def test_wrong_sci_refund_params_1(self):
        """ Calc for sci_pay from LTC 0.5 BTC by OWNER with common absolute fee 0.001 BTC. """
        admin.set_wallet_amount(balance=bl(0), currency='LTC', merch_lid=user1.merchant1.lid)
        admin.set_fee(currency_id=admin.currency['LTC'], payway_id=admin.payway_id['ltc'], tp=40, is_active=True,
                      add=bl(0.001))
        admin.set_fee(currency_id=admin.currency['LTC'], payway_id=admin.payway_id['ltc'], tp=45, is_active=True,
                      add=bl(0.001))
        admin.set_fee(currency_id=admin.currency['LTC'], payway_id=admin.payway_id['ltc'], tp=46, is_active=True,
                      add=bl(0.001))
        admin.set_pwc(pw_id=admin.payway_id['ltc'], currency='LTC', is_out=False, is_active=True,
                      tech_min=bl(0.0008), tech_max=bl(200))
        admin.set_pwmerchactive(merch_id=user1.merchant1.id, payway_id=admin.payway_id['btc'], is_active=True)
        user1.delegate(params={'externalid': user1.ex_id(), 'expiry': '7d', 'm_lid': user1.merchant1.lid,
                               'merch_model': 'sci_pay', 'merch_method': 'create',
                               'payway': 'ltc', 'amount': '0.5', 'in_curr': 'LTC'})
        # pprint.pprint(user1.resp_delegate)
        sci_pay_lid = user1.resp_delegate['lid']
        sci_pay_token = user1.resp_delegate['token']
        user1.delegate(params={'sci_pay_token': sci_pay_token, 'externalid': user1.ex_id(), 'm_lid': user1.merchant1.lid,
                               'merch_model': 'sci_subpay', 'merch_method': 'create', 'payway': 'ltc', 'amount': '0.4',
                               'in_curr': 'LTC', 'contact': '32LdQGCG1PHYNP2sRkZgrP6UAfQYTSkshx'})
        # pprint.pprint(user1.resp_delegate)
        admin.set_order_status(lid=user1.resp_delegate['lid'], status=100)
        admin.set_order_status(lid=sci_pay_lid, status=0, amount_paid=bl(0.4))
        user1.delegate(params={'sci_pay_token': sci_pay_token, 'externalid': user1.ex_id(), 'm_lid': user1.merchant1.lid,
                               'merch_model': 'sci_subpay', 'merch_method': 'create', 'payway': 'ltc', 'amount': '0.1',
                               'in_curr': 'LTC', 'contact': '32LdQGCG1PHYNP2sRkZgrP6UAfQYTSkshx'})
        # pprint.pprint(user1.resp_delegate)
        admin.set_order_status(lid=user1.resp_delegate['lid'], status=100)
        admin.set_order_status(lid=sci_pay_lid, status=100, amount_paid=bl(0.5))
        user1.merchant1.balance(curr='LTC')
        assert user1.merchant1.resp_balance['LTC'] == '0.499'
        user1.delegate(params={'m_lid': user1.merchant1.lid,  'merch_model': 'sci_refund', 'merch_method': 'params',
                               'curr': 'LTC'})
        # pprint.pprint(user1.resp_delegate)
    ...
    def test_wrong_sci_refund_params_2(self):
        """ Calc for sci_pay from LTC 0.5 BTC by OWNER with common absolute fee 0.001 BTC. """
        admin.set_wallet_amount(balance=bl(0), currency='LTC', merch_lid=user1.merchant1.lid)
    ...
    def test_wrong_sci_refund_params_3(self, _enable_currency):
        """ SCI payin from QIWI 10 RUB by OWNER with common absolute fee 1 RUB and common percent fee 5.5% . """
        admin.set_wallet_amount(balance=0, currency='RUB', merch_lid=user1.merchant1.lid)
        admin.set_fee(currency_id=admin.currency['RUB'], payway_id=admin.payway_id['qiwi'], tp=40, is_active=True,
                      mult=pers(5.5), add=bl(1))
        ...
        admin.set_order_status(lid=user1.resp_delegate['lid'], status=100)
        admin.set_order_status(lid=sci_pay_lid, status=0, amount_paid=bl(4))
        admin.set_pwc(pw_id=admin.payway_id['anycash'], currency='RUB', is_out=True, is_active=False,
                      tech_min=bl(0.01), tech_max=bl(3000))
